...
$DAEMON_NAME tx gov submit-proposal software-upgrade $UPGRADE_NAME --title "Upgrade to $UPGRADE_NAME" --description "Upgrade to $UPGRADE_NAME" --deposit 10000000$DENOM --upgrade-height 1500 --from me --chain-id $CHAIN_ID --keyring-backend test --home $DAEMON_HOME --node tcp://localhost:26657 --yes --gas-prices $GAS_PRICE$DENOM --gas auto --gas-adjustment 1.5 --broadcast-mode block
