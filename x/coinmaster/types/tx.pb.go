...
func init() {
	proto.RegisterType((*MsgMint)(nil), "cdbo.cdnode.coinmaster.MsgMint")
	proto.RegisterType((*MsgMintResponse)(nil), "cdbo.cdnode.coinmaster.MsgMintResponse")
	proto.RegisterType((*MsgBurn)(nil), "cdbo.cdnode.coinmaster.MsgBurn")
	proto.RegisterType((*MsgBurnResponse)(nil), "cdbo.cdnode.coinmaster.MsgBurnResponse")
}
...
var fileDescriptor_2f68783d02bba24b = []byte{
	...
	,
}
...
func (c *msgClient) Mint(ctx context.Context, in *MsgMint, opts ...grpc.CallOption) (*MsgMintResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cdbo.cdnode.coinmaster.Msg/Mint", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) Burn(ctx context.Context, in *MsgBurn, opts ...grpc.CallOption) (*MsgBurnResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cdbo.cdnode.coinmaster.Msg/Burn", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_Mint_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cdbo.cdnode.coinmaster.Msg/Mint",
	}
...
func _Msg_Burn_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cdbo.cdnode.coinmaster.Msg/Burn",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "cdbo.cdnode.coinmaster.Msg",
